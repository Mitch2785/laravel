...
<x-layouts.app title="Blog" meta-description="Blogs meta description">
    ...
    <main class="grid w-full gap-4 px-4 max-w-7xl sm:grid-cols-2 md:grid-cols-3">
        ...
        <div class="max-w-3xl px-4 py-2 space-y-4 bg-white rounded shadow dark:bg-slate-800" style="" >
            <h2 class="text-xl text-slate-600 dark:text-slate-300 hover:underline">
                <a href="{{route('posts.show', $post )}}"> {{ $post->title }}</a></h2>
            @auth()
